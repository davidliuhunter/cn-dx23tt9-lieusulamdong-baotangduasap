...
import { getAllArtifacts, getCollections } from '@/src/lib/data';
import { saveArtifact, deleteArtifact } from '@/src/lib/actions';
import ImageUpload from '@/src/components/ImageUpload';
import type { Artifact, Collection } from '@/src/lib/types';
